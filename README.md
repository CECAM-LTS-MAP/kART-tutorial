...
3. Download the `Tutorial_new.tgz`file and untar it in the `software/kart_tutorial` directory with `% tar xzf tutorial_new.tar.gz`
4. Install the csh shell : ` % sudo apt-get install csh`
